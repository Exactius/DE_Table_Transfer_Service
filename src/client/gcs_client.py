...
class GoogleCloudStorageClient:
    ...
    def upload_dataframe_as_csv(self, dataframe: pd.DataFrame, bucket_name: str, filename: str) -> Dict[str, Any]:
        logger.info(f"Starting upload to GCS: gs://{bucket_name}/{filename}")
        ...
        logger.info(f"Upload completed successfully to gs://{bucket_name}/{filename}")
